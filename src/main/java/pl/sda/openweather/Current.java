...
public class Current {
    ...
    public Current(Condition condition, String last_updated_epoch, String last_updated, double temp_c, double temp_f, int is_day, double wind_mph, double wind_kph, int wind_degree, String wind_dir, double pressure_mb, double pressure_in, int precip_mm, int precip_in, int humidity, int cloud, double feelslike_c, double feelslike_f, int vis_km, int vis_miles, int uv) {
